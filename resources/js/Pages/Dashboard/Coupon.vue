...
<template>
    ...
    <AppLayout>
        ...
        <div class="w-full flex flex-col px-4 pb-10 mt-4 gap-4">
            <!-- Hero card -->
            <div class="rounded-2xl p-5 text-center relative overflow-hidden bg-primary">
                <div
                    class="absolute top-0 right-0 w-28 h-28 rounded-full opacity-10 bg-white"
                    style="transform: translate(30%, -30%)"
                ></div>
                <div class="w-12 h-12 rounded-xl bg-primary-foreground/10 flex items-center justify-center mx-auto mb-3">
                    <Icon name="ticket" class="text-primary-foreground text-xl" />
                </div>
                <p class="text-primary-foreground text-sm font-medium tracking-wide mb-1">Got a coupon code?</p>
                <p class="text-primary-foreground/70 text-xs tracking-wide">
                ...
                <form class="flex flex-col gap-4" @submit.prevent="submit">
                    <div class="rounded-2xl px-4 py-3 bg-secondary border border-border">
                        ...
                        <input
                            ...
                            autocomplete="off"
                            class="w-full bg-transparent outline-none text-sm text-foreground placeholder-muted-foreground/60 uppercase tracking-widest"
                            required
                            @input="uppercase"
                        />
                    </div>
