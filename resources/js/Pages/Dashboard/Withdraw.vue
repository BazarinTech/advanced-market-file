                ...
                <div class="rounded-2xl p-5 bg-card border border-border">
                    ...
                    <form class="flex flex-col gap-4" @submit.prevent="submitSetup">
                        ...
                        <button
                            ...
                            class="w-full bg-primary hover:bg-amber-700 text-primary-foreground font-bold py-3 rounded-2xl tracking-widest uppercase text-xs flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
                        >
                ...
                <div class="rounded-2xl px-4 py-4 flex items-center justify-between bg-card border border-border">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-xs text-muted-foreground mt-2">
                            <a :href="route('account')" class="text-primary no-underline hover:text-foreground text-[9px] tracking-widest">Change? Support</a>
                        </p>
                    </div>
                </div>
