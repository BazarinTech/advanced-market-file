        ...
        <div class="flex flex-col items-center justify-center w-full min-h-screen px-6">
            <div class="text-center mb-10">
                <div class="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center mx-auto mb-4">
                    <Icon name="chart-line" class="text-primary-foreground text-2xl" />
                </div>
            ...
            <form class="w-full flex flex-col gap-4" @submit.prevent="submit">
                ...
                <button
                    ...
                    class="w-full bg-primary hover:bg-[#00a88a] text-primary-foreground font-bold py-3.5 rounded-xl tracking-[0.2em] uppercase text-sm mt-2 flex items-center justify-center gap-2 disabled:opacity-70"
                >
                    {{ form.processing ? 'Signing in...' : 'Sign In' }}
                </button>
                <div class="flex items-center justify-between mt-1">
                    <Link :href="route('forgot')" class="text-muted-foreground text-xs tracking-widest uppercase hover:text-primary">
                        Forgot Password?
                    </Link>
                    <Link :href="route('register')" class="text-primary text-xs tracking-widest uppercase hover:text-white">
                        Create Account
                    </Link>
                </div>
            </form>
