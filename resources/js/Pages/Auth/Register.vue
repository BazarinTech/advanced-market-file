        ...
        <div class="flex flex-col items-center justify-center w-full min-h-screen px-6 py-10">
            ...
            <form class="w-full flex flex-col gap-3" @submit.prevent="submit">
                ...
                <div class="rounded-xl px-4 py-3 bg-card border border-border">
                    ...
                    <select v-model="form.country" class="w-full bg-card outline-none text-sm text-white" required>
                ...
                <button
                    ...
                    class="w-full bg-primary hover:bg-[#00a88a] text-primary-foreground font-bold py-3.5 rounded-xl tracking-[0.2em] uppercase text-sm mt-2 disabled:opacity-70"
                >
